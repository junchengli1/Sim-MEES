...
parser.add_argument("--suction_radius", type=float, default=1.5, choices=[1.5,2.5],help="choose suction radius 1.5cm or 2.5cm")
...
def draw(DATA_ROOT,STAGE_ID,MODE,GROUND_PLANE,RADIUS):
    ...
    if RADIUS==1.5:
        ...
        candidate_seal_path=DATA_ROOT+f"stage_{STAGE_ID}"+ f"/stage_{STAGE_ID}_candidates_after_seal_2.5cm.pkl"
        candidate_simulation_path=DATA_ROOT+f"stage_{STAGE_ID}"+ f"/stage_{STAGE_ID}_seal_simulation_candidates_2.5cm.pkl"
